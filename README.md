...
A project for monitoring the three-phase energy monitor **[Shelly 3EM](https://www.shelly.com/products/shelly-pro-3em-x1)** using **[Prometheus](https://prometheus.io/)** and **[JSON Exporter](https://github.com/prometheus-community/json_exporter)**. The system converts the Shelly 3EM device's JSON API into Prometheus format metrics for subsequent analysis and visualization.
...
Example of real metrics output from JSON Exporter:
