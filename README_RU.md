...
Проект для мониторинга трехфазного энергомонитора **[Shelly 3EM](https://www.shelly.com/products/shelly-pro-3em-x1)** с использованием **[Prometheus](https://prometheus.io/)** и **[JSON Exporter](https://github.com/prometheus-community/json_exporter)**. Система преобразует JSON API устройства Shelly 3EM в метрики формата Prometheus для последующего анализа и визуализации.
